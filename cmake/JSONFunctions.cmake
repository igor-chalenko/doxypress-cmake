...
function(JSON_serialize _variables _out_json)
    ...
    doxypress_log(DEBUG "inputs were: ${_inputs}")
    foreach (_var ${_variables})
        ...
        if (${_var_without_prefix}_INPUT IN_LIST _properties)
            ...
            if (_input_parameter)
                doxypress_log(DEBUG "_input_parameter = ${_input_parameter}")
            endif()
            if (${_input_parameter} IN_LIST _inputs)
                doxypress_log(DEBUG "input argument given: ${_input_parameter}")
                set(_found true)
            endif()
        endif()
        ...
        if (NOT _found)
            ...
            doxypress_log(DEBUG "Won't override ${_var_without_prefix}")
        endif()
